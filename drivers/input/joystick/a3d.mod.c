...
__attribute__((section("__versions"))) = {
	...
	{ 0x168b276c, __VMLINUX_SYMBOL_STR(__gameport_register_port) },
	{ 0x275043b, __VMLINUX_SYMBOL_STR(gameport_set_phys) },
	...
	{ 0x29bf8db0, __VMLINUX_SYMBOL_STR(gameport_unregister_port) },
