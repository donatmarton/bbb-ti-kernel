...
__attribute__((section("__versions"))) = {
	...
	{ 0xe60ef0bf, __VMLINUX_SYMBOL_STR(__gameport_register_port) },
	{ 0xcc2be6f0, __VMLINUX_SYMBOL_STR(gameport_set_phys) },
	...
	{ 0xa2b49ac8, __VMLINUX_SYMBOL_STR(gameport_unregister_port) },
