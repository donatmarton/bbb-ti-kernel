...
__attribute__((section("__versions"))) = {
	...
	{ 0x791fec95, __VMLINUX_SYMBOL_STR(input_allocate_polled_device) },
	...
	{ 0x890393c2, __VMLINUX_SYMBOL_STR(input_free_polled_device) },
	{ 0xe47212bd, __VMLINUX_SYMBOL_STR(input_unregister_polled_device) },
