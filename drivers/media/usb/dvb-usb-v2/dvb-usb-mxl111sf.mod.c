...
__attribute__((section("__versions"))) = {
	...
	{ 0x59de7e04, __VMLINUX_SYMBOL_STR(dvb_usbv2_generic_rw) },
	...
	{ 0xdbbbdebd, __VMLINUX_SYMBOL_STR(dvb_usbv2_generic_write) },
};
...
MODULE_INFO(srcversion, "D0B0B21C6244114F04F2D10");
