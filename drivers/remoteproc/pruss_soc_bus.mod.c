...
__attribute__((section("__versions"))) = {
	...
	{ 0xcf51cc5, __VMLINUX_SYMBOL_STR(of_iomap) },
...
MODULE_ALIAS("of:N*T*Cti,am3356-pruss-soc-bus");
MODULE_ALIAS("of:N*T*Cti,am3356-pruss-soc-busC*");
MODULE_ALIAS("of:N*T*Cti,am4376-pruss-soc-bus");
MODULE_ALIAS("of:N*T*Cti,am4376-pruss-soc-busC*");
MODULE_ALIAS("of:N*T*Cti,am5728-pruss-soc-bus");
MODULE_ALIAS("of:N*T*Cti,am5728-pruss-soc-busC*");
MODULE_ALIAS("of:N*T*Cti,k2g-pruss-soc-bus");
MODULE_ALIAS("of:N*T*Cti,k2g-pruss-soc-busC*");
