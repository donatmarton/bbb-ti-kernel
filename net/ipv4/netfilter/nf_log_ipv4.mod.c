...
__attribute__((section("__versions"))) = {
	...
	{ 0xa6f09581, __VMLINUX_SYMBOL_STR(nf_log_dump_udp_header) },
	{ 0x2b7b3a4d, __VMLINUX_SYMBOL_STR(nf_log_dump_sk_uid_gid) },
	{ 0xf07f66b1, __VMLINUX_SYMBOL_STR(nf_log_dump_tcp_header) },
