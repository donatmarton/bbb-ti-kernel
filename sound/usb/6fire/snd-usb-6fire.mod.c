...
__attribute__((section("__versions"))) = {
	...
	{ 0x2bdb4a0d, __VMLINUX_SYMBOL_STR(_snd_ctl_add_slave) },
	...
	{ 0x9d51a0bb, __VMLINUX_SYMBOL_STR(snd_ctl_boolean_stereo_info) },
	...
	{ 0x8b0ff131, __VMLINUX_SYMBOL_STR(snd_ctl_make_virtual_master) },
